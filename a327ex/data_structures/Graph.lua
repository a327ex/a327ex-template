...
function Graph:set_nodes()
  self.nodes = {}
  for node, _ in pairs(self.adjacency_list) do table.insert(self.nodes, node) end
end
...
function Graph:remove_node(node)
  for _node, list in pairs(self.adjacency_list) do self:remove_edge(node, _node) end
